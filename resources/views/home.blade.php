                    ...
                    <div class="d-flex align-items-center justify-content-between p-3 w-100">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu bg-transparent py-0" aria-labelledby="dropdownMenuButton" style="border: none;">
                                ...
                                <li class="w-75">
                                    <a class="dropdown-item dropdown-box" href="{{ route('resume.view-edit-resume', $resume->id) }}"><small>Edit</small></a>
                                </li>
                                <li class="w-75">
                                    <button type="button" class="dropdown-item dropdown-box" onclick="triggerDelete({{ $resume->id }},'{{ $resume->title }}')" data-bs-toggle="modal" data-bs-target="#deleteModal"><small>Delete</small></button>
                                </li>
                            </ul>
                        </div>
                    </div>
